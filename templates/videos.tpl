...
{include file="{$prefix}nav.tpl" currentnav="videos"}
    ...
    function showMyVideo(fileInput){
        ...
        function onSaveClicked(mode)
            {
                         ...
                         var video_type_id=$('#video_type_in').val();
                          ...
                          document.video_title_form.channel_in.value=channel_id;
        ...
        function getVideokindId(id){
             ...
             function modify(id)
            {
                    ...
                    location.href = "videos.php?action=modify&id="+id;
            ...
            function deleteImage(id){
			 if(confirm("Are you sure you want to delete this video?") == true)
                {
                    location.href = "videos.php?action=delete&id="+id;
...
<div class="body">
    ...
    <h2 class="heading2">Edit Video</h2>
    <div id="div_seperate" class="div_seperate"></div>
    <div id="div_user_video" class="video_edit">
        <div class="div_form">
           <form action="{$prefix}videos.php?action=create" name="video_title_form" method="post" id = "video_title_form" enctype="multipart/form-data">
            ...
            <ul>
                ...
                <li style="margin-left:30px;" > 
                 <div style="height:200px;">
                    <p>Video Title*</br><input type="text" name="title" value="{$title}" class="input_data_question" placeholder="Enter Video Title ."/></br>
                    Choose Category*</br>
        ...
        <h2 class="heading2">Video Table</h2>
		<div id="div_seperate" class="div_seperate"></div></br>
            ...
            <table id="videos" class="stats" border="1" border-spacing="1px"  >
                    ...
                    {foreach from=$videos item="data"}
                        <tr class="statsrow">
                            ...
                            <td width="5%" height="100">
                                <TEXTAREA NAME="description" value="{$video_description}" COLS=8 ROWS=5 disabled class="textarea_none"> {$data['channel_name']}</TEXTAREA>
                            </td>
                            <td width="5%" height="100">
