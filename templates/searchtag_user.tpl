...
{include file="{$prefix}nav_user.tpl" currentnav="search"}
...
<script>
	...
	function onSaveClicked(mode)
             ...
             function modify(id)
            {
                    ...
                    location.href = "searchtag_user.php?action=modify&id="+id;
            ...
            function deleteImage(id){
			 if(confirm("Are you sure to delete this tag?") == true)
                {
                    location.href = "searchtag_user.php?action=delete&id="+id;
...
<div class="body">
    ...
    <div id="div_user_video" class="user_edit">
        <div class="div_form">
           <form action="{$prefix}searchtag_user.php?action=create" name="video_title_form" method="post" id = "video_title_form" enctype="multipart/form-data">
